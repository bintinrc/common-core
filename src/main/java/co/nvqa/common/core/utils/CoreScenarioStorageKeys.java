...
public interface CoreScenarioStorageKeys {
  ...
  String KEY_LIST_OF_CREATED_ORDERS_CORE_DB = "KEY_LIST_OF_CREATED_ORDERS_CORE_DB";
  String KEY_LIST_OF_RESERVATION_IDS = "KEY_LIST_OF_RESERVATION_IDS";
  String KEY_LIST_OF_ORDER_PICKUPS = "KEY_LIST_OF_ORDER_PICKUPS";
  ...
  String KEY_LIST_OF_RESERVATIONS_DB = "KEY_LIST_OF_RESERVATIONS_DB";

  String KEY_SAVED_ORDER_WEIGHT = "KEY_SAVED_ORDER_WEIGHT";
  String KEY_EXPECTED_OLD_WEIGHT = "KEY_EXPECTED_OLD_WEIGHT";
  String KEY_LIST_OF_CREATED_STAMP_ID = "KEY_LIST_OF_CREATED_STAMP_ID";
